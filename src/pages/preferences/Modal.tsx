          ...
          >
            ...
            >
              {children ? (
                ...
                <div
                  className={`${theme} h-96 dark:bg-gray-800 bg-gray-100 flex justify-center items-center`}
                >
                  <div role="status">
                    <svg
                      aria-hidden="true"
                      className="inline w-44 h-44 mr-2 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600"
                      viewBox="0 0 100 101"
                      fill="none"
